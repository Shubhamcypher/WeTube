...
app.use(cors({
    origin: ['https://we-tube-mu.vercel.app', 'https://server-rwug.onrender.com', 'http://localhost:5173','http://localhost:8000/','https://nominatim.openstreetmap.org','http://192.168.57.110'],
